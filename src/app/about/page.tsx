      ...
      <section className="min-h-screen py-20">
        ...
        <div className="mx-auto container px-4">
          <div className="py-30 border-b border-gray-300">
            <p className="uppercase tracked-[0.22rem]">A little context</p>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between py-40 space-y-6">
            ...
            <div className="max-w-lg text-xl">
              <p>
                I'm an independent product designer and developer based between
                London and New York. Over the past eight years, I've partnered
                with early-stage founders and established teams to make digital
                products more human.
              </p>
              <br />
              <p>
